...
and can be run on any branch in anemoi-core based on which you would like to update the configs. You'll need to
provide the path to your local anemoi repo, and can run it like so:
